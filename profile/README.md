...
:root{
  ...
  --acc:#f78166;--blue:#58a6ff;--green:#3fb950;--amber:#d29922;--purple:#bc8cff;--teal:#39c5cf;
  --red:#ff7b72;--border:#30363d;
  --mono:'JetBrains Mono',monospace;--sans:'Inter',sans-serif;
}
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
html{scroll-behavior:smooth}
body{font-family:var(--sans);background:var(--bg);color:var(--tx);font-size:13.5px;line-height:1.7}
.page{max-width:1040px;margin:0 auto;padding:0 24px 80px}

/* cover */
.cover{padding:56px 0 44px;border-bottom:1px solid var(--border);margin-bottom:44px}
.ctag{font-family:var(--mono);font-size:10px;letter-spacing:.2em;text-transform:uppercase;color:var(--acc);margin-bottom:12px}
.cover h1{font-size:clamp(36px,5vw,60px);font-weight:600;letter-spacing:-2px;line-height:1.05;margin-bottom:8px;color:var(--tx)}
.csub{font-size:15px;color:var(--tx2);margin-bottom:24px}
.cpills{display:flex;gap:8px;flex-wrap:wrap}
.cp{padding:3px 10px;border:1px solid var(--border);border-radius:100px;font-family:var(--mono);font-size:10px;color:var(--tx3)}
.cp b{color:var(--acc)}

/* nav sidebar style toc */
.toc-bar{background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:20px;margin-bottom:36px}
.toc-title{font-family:var(--mono);font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--acc);margin-bottom:12px}
.toc-cols{display:grid;grid-template-columns:1fr 1fr 1fr;gap:2px}
@media(max-width:640px){.toc-cols{grid-template-columns:1fr}}
.toc-cols a{display:block;padding:3px 0;text-decoration:none;color:var(--tx2);font-size:12px;transition:color .12s}
.toc-cols a:hover{color:var(--blue)}
.toc-cols a span{font-family:var(--mono);font-size:10px;color:var(--acc);margin-right:6px}

/* section */
.ch{margin-bottom:60px;scroll-margin-top:20px}
.ch-hd{display:flex;align-items:baseline;gap:12px;margin-bottom:24px;padding-bottom:10px;border-bottom:1px solid var(--border)}
.ch-n{font-family:var(--mono);font-size:10px;color:var(--acc);letter-spacing:.1em}
.ch-t{font-size:20px;font-weight:600;color:var(--tx)}
h3{font-size:15px;font-weight:500;color:var(--tx);margin:22px 0 10px}
h4{font-family:var(--mono);font-size:10px;text-transform:uppercase;letter-spacing:.12em;color:var(--tx3);margin:14px 0 6px}
p{color:var(--tx2);margin-bottom:10px;font-size:13.5px}
p:last-child{margin-bottom:0}
strong{color:var(--tx);font-weight:500}
em{color:var(--amber);font-style:normal}

/* callout boxes */
.box{border-radius:6px;padding:12px 16px;margin:14px 0;border-left:3px solid}
.box.red{background:rgba(255,123,114,.06);border-color:var(--red)}
.box.blue{background:rgba(88,166,255,.06);border-color:var(--blue)}
.box.green{background:rgba(63,185,80,.06);border-color:var(--green)}
.box.amber{background:rgba(210,153,34,.06);border-color:var(--amber)}
.box.purple{background:rgba(188,140,255,.06);border-color:var(--purple)}
.box.teal{background:rgba(57,197,207,.06);border-color:var(--teal)}
.box-lbl{font-family:var(--mono);font-size:9px;letter-spacing:.15em;text-transform:uppercase;color:var(--tx3);margin-bottom:5px}

/* code blocks */
pre{background:var(--bg2);border:1px solid var(--border);border-radius:6px;padding:14px 16px;overflow-x:auto;margin:12px 0}
code{font-family:var(--mono);font-size:12px;color:var(--blue)}
pre code{color:var(--tx);font-size:12px;line-height:1.6}
.kw{color:var(--purple)}
.str{color:var(--green)}
.cm{color:var(--tx3)}
.num{color:var(--amber)}
...
th{padding:8px 10px;text-align:left;font-family:var(--mono);font-size:10px;text-transform:uppercase;letter-spacing:.08em;color:var(--tx3);white-space:nowrap}
td{padding:8px 10px;border-bottom:1px solid rgba(48,54,61,.5);color:var(--tx2);vertical-align:top}
tr:last-child td{border-bottom:none}
td:first-child{color:var(--tx);font-weight:500}
tr:hover td{background:rgba(255,255,255,.02)}

/* tags */
.tag{display:inline-block;font-family:var(--mono);font-size:10px;padding:1px 6px;border-radius:3px;font-weight:500}
.tr{background:rgba(255,123,114,.15);color:var(--red)}
.tg{background:rgba(63,185,80,.15);color:var(--green)}
.tb{background:rgba(88,166,255,.15);color:var(--blue)}
.ta{background:rgba(210,153,34,.15);color:var(--amber)}
.tp{background:rgba(188,140,255,.15);color:var(--purple)}
.ttl{background:rgba(57,197,207,.15);color:var(--teal)}
...
/* formula block */
.formula{background:var(--bg3);border:1px solid var(--border);border-radius:6px;padding:10px 14px;font-family:var(--mono);font-size:12px;color:var(--teal);margin:10px 0}
.formula .var{color:var(--amber)}
.formula .eq{color:var(--tx3)}

/* inline code */
ic{font-family:var(--mono);font-size:11px;background:var(--bg3);padding:1px 5px;border-radius:3px;color:var(--blue)}

.div{height:1px;background:var(--border);margin:20px 0}
.footer{margin-top:56px;padding-top:16px;border-top:1px solid var(--border);font-family:var(--mono);font-size:10px;color:var(--tx3);display:flex;justify-content:space-between;flex-wrap:wrap;gap:6px}
</style>
</head>
<body>
<div class="page">
